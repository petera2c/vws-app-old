  ...
  return (
    <Page className="flex flex-col bg-blue-2">
      ...
      <p>
        ...
        recorded by Vent With Strangers and how we use it.
      </p>
      <p>
      ...
      <p>
        ...
        shared and/or collect in Vent With Strangers. This policy is not
      ...
      <h2>Log Files</h2>
      <p>
        Vent With Strangers follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, Vent With Strangers uses 'cookies'. These
      ...
      <p>
        ...
        advertising partners of Vent With Strangers.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Vent With Strangers, which are
      ...
      <p>
        Note that Vent With Strangers has no access to or control over these
        cookies that are used by third-party advertisers.
      </p>
      <h2>Third Party Privacy Policies</h2>
      <p>
        Vent With Strangers's Privacy Policy does not apply to other advertisers
      ...
      <p>
        Vent With Strangers does not knowingly collect any Personal Identifiable
